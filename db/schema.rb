...
ActiveRecord::Schema[8.1].define(version: 2026_08_20_000001) do
  ...
  create_table "logout_deliveries", id: :string, force: :cascade do |t|
    t.integer "application_id", null: false
    t.datetime "created_at", null: false
    t.string "detail"
    t.string "sid", null: false
    t.string "status", null: false
    t.index ["application_id"], name: "index_logout_deliveries_on_application_id"
    t.index ["sid", "created_at"], name: "index_logout_deliveries_on_sid_and_created_at"
  end
  ...
  add_foreign_key "logout_deliveries", "oauth_applications", column: "application_id"
